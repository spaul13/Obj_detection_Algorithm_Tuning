...
batch_size = 8#3#1#4 #batch_size for training
log_step = 300 #990 #450
comp_techs = 3
path_saved_model = "C:\\temp\\sibu_0330_opencv_nograd_model"
...
#                    #print("[epoch:%d, batch:%5d] loss: %.3f" % (epoch + 1, i + 1, running_loss / float(2000)))
    ...
    def compress(self, infile, file_index, reso_weight, jpeg_weight, encode_weight):
        ...
        #if(jpeg_qp<10):
        #    jpeg_qp = 10
        temp_jpeg = "temp_5.jpg"
        tempfile = "temp_5.mp4"
        outfile = "temp_5_org.png"
